...
`))
  ...
  console.log(`  ${c.dim('--preview')}           Preview settlements without executing`)
  console.log(``)
  ...
  console.log(``)
  console.log(c.dim(`  # Preview all settlements`))
  console.log(`  filpay rails settle-all --key YOUR_KEY --preview`)
  console.log(``)
